				...
				if(show && !cShow && thisTemp.controlBarIsShow) {
					...
					if(cShow) {
						...
						if(!paused) {
							...
							if(thisTemp.CB&&thisTemp.CB['controlBarBg'])thisTemp.css(thisTemp.CB['controlBarBg'], 'display', 'none');
							if(thisTemp.CB&&thisTemp.CB['controlBar'])thisTemp.css(thisTemp.CB['controlBar'], 'display', 'none');
							if(thisTemp.CB&&thisTemp.CB['timeProgressBg'])thisTemp.css(thisTemp.CB['timeProgressBg'], 'display', 'none');
							if(thisTemp.CB&&thisTemp.CB['timeBoBg'])thisTemp.css(thisTemp.CB['timeBoBg'], 'display', 'none');
							thisTemp.promptShow(false);
